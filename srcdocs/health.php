...
if($self['unread']) {
  ...
  $self['desc'] = <<<END
    LaHLab is my playground for recovery and primarly for WHORTH development.
    WHORTH is a new take on FORTH still in early design fase.
    END;
  $self['unread'] = 0;
}
if($honly) {
...
<p class="ing">Since then I have quite intensely tried coding to recover. Neuroplasticity is a thing but it don't come for free, at least not at age. <a class="rml" title="WHORTH" href="index.html">»</a>WHORTH is the first project reaching some interesting level. It is a good bit too ambitious for me right now but I plan on keeping improving. Anyhow, giving up is pointless!</p>
